...
1&2: "Open source enables technology agility, typically offering multiple ways to solve problems...I could do it on my own with the open source software available freely over the Internet. I could start building a project, or a platform, or testing feasibility or developing my skills." -- also enables speed like the cathedral and the bazaar
5: the responsiveness of the open source community and vendors relative to information security problems has been very good. The fact that we’ve had eyes on code that in some cases is decades old, and we were able to identify and fix problems when they became apparent, rather than have the code molder in a proprietary environment where few knew about the exposure but some were exploiting it, is an advantage of open source. -- similar to 1&2 where more eyes on the code/software the better
7 *but overall: One of the fundamental advantages of open source is community involvement. 
8: Open source is the future. Web, mobile, and cloud solutions are increasingly built predominantly on open source infrastructure. Some data and analytic solutions are only available in open source. 
Similarly to how the article, 8 advantages of using open soure in the enterprise, states as their 8th advantage: Open source is the future. 
-->
