...
1. Consultancies: build open source solutions for their customers on contract, often around existing open source technologies.    
2. Subscription Offerings: companies here sell customers annual subscriptions which provide support, updates, and access to all current binary releases of the software.  
